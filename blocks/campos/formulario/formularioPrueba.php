...
class FormularioRegistro {
	...
	function formulario() {
		...
		// ----------------INICIO CONTROL: Campo de Texto 1--------------------------------------------------------
		$esteCampo = 'campo_texto1';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		...
		unset ( $atributos );
		// ----------------FIN CONTROL: Campo de Texto 1--------------------------------------------------------
				
				
		// ----------------INICIO CONTROL: Campo de Texto 2--------------------------------------------------------
		$esteCampo = 'campo_texto2';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		$atributos ['estilo'] = 'jqueryui';
		...
		$atributos ['anchoCaja'] = 60;
		$atributos ['miEvento'] = '';
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "persona" );
		$matrizItems = array (
				array (
						0,
						' '
